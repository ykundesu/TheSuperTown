...
{
    [BepInPlugin(Id, "TheSuperTown", VersionString)]
    [BepInDependency(SubmergedCompatibility.SUBMERGED_GUID, BepInDependency.DependencyFlags.SoftDependency)]
    [BepInProcess("Among Us.exe")]
    public class TheSuperTownPlugin : BasePlugin
    {
        public const string Id = "jp.mod.thesupertown";
        ...
        public static TheSuperTownPlugin Instance;
        ...
        class TranslateControllerMessagePatch
        {
            ...
            {
                TheSuperTownPlugin.Logger.LogInfo(id+":"+__result);
            }
        }*/
